...
(function($) {
	...
	$.fn.prettyPhoto = function(pp_settings) {
		pp_settings = jQuery.extend({
			...
			slideshow: 7000, /* Время показа слайд-шоу: false или интервал в миллисекундах */
			autoplay_slideshow: true, /* Автозапуск слайд-шоу true/false */
			opacity: 1.0, /* Прозрачность фона от 0 до 1 */
			...
			overlay_gallery_max: 30, /* Число превьюшек внизу окна (должно быть больше кол-ва фотографий) */

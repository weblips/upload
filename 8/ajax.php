	...
	*/
	...
	if ($uploadImages->validateImages())
	{
		...
		foreach ($images as $image)
		{
			...
			{
				print ("<p class='text-success'>В· <strong>" . $image["name"] . "</strong> Сохранено в папке ". __DIR__. "</p>");
			}
			else
			{
				print("<p class='text-danger'>В· " . $image["name"] . " Ошибка загрузки</p>");
			}
		}
		/* GET EXTRA PARAMETERS */
		print("<h3 class='text-info'>Доп параметры</h3>");
